            ...
            <div className="mx-auto flex max-w-5xl flex-col items-start justify-between gap-6 px-6 py-10 md:flex-row md:items-center">
                ...
                <div className="flex items-center gap-4 text-neutral-500 dark:text-neutral-400">
                    <a
                        ...
                        rel="noreferrer"
                        aria-label="GitHub"
                        className="transition-colors hover:text-neutral-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-900 focus-visible:ring-offset-2 rounded-sm"
                    >
